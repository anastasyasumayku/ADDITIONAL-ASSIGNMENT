            ...
            <div className="container px-4">
                <div className="row gx-4 justify-content-center">
                    <div className="col-lg-8">
                        <h2>About Us</h2>
                        <p className="lead">Hello im from University of Klabat and present to you my web that i make from various source, this is my name :</p>
                        <ul>
                            <li>Name : Michael Victorio Bongso</li>
                            <li>NIM : 105021910059</li>
